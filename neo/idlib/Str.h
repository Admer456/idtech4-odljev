...
public:
	...
	bool				Eq( const char *text ) const;

						// case insensitive compare
	int					Icmp( const char *text ) const;
	int					Icmpn( const char *text, int n ) const;
	int					IcmpPrefix( const char *text ) const;
	bool				Ieq( const char *text ) const;
...
ID_INLINE bool idStr::Eq( const char *text ) const
{
	assert( text );
	return idStr::Eq( data, text );
}
...
ID_INLINE bool idStr::Ieq( const char *text ) const
{
	assert( text );
	return idStr::Ieq( data, text );
}
