...
/*
================
idAFEntity_Base::OnUse
================
*/
void idAFEntity_Base::OnUse( idPlayer *player )
{
	player->isUsing = true;
...
/*
================
idAFEntity_Base::OnUnuse
================
*/
void idAFEntity_Base::OnUnuse( idPlayer *player )
{
...
void idAFEntity_Gibbable::Gib( const idVec3 &dir, const char *damageDefName ) {
	...
	if ( g_bloodEffects.GetBool() && !gameLocal.mpGame.IsGametypeCoopBased() )
	{ //unable to spawn gibs yet in coop
...
bool idGameEdit::AF_SpawnEntity( const char *fileName )
{
	...
	player->usedDragEntity.SetSelected( ent );
