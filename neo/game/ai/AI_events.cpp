...
const idEventDef AI_SpookNearby( "spookNearby", "ff" );
const idEventDef AI_UnspookNearby( "unspookNearby", "ff" );
...
CLASS_DECLARATION( idActor, idAI )
	...
	EVENT( AI_SpookNearby,						idAI::Event_SpookNearby )
	EVENT( AI_SpookNearby,						idAI::Event_SpookNearby )
END_CLASS
...
void idAI::Event_SpookNearby( float upto, float radius )
{
	SpookNearbyPlayers( upto, radius );
}

void idAI::Event_UnspookNearby( float downto, float radius )
{
	UnspookNearbyPlayers( downto, radius );
}
