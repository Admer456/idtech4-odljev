...
idCVar g_infiniSlide(				"g_infiniSlide",			"0",			CVAR_GAME | CVAR_BOOL | CVAR_NETWORKSYNC,	"Infinite sliding bug. 0 - disabled, 1 - enabled" );
idCVar g_enableHudAid(				"g_enableHudAid",			"0",			CVAR_GAME | CVAR_BOOL | CVAR_ARCHIVE,		"Enables health, crosshair etc. on HUD");
...
idCVar v_weaponSwayForward(			"v_weaponSwayForward",		"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "" );
idCVar v_weaponSwaySide(			"v_weaponSwaySide",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "" );
idCVar v_weaponSwayUp(				"v_weaponSwayUp",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "" );

idCVar v_crouchPushUp(				"v_crouchPushUp",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "" );
idCVar v_crouchPushFr(				"v_crouchPushFr",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "" );

idCVar v_rollSide(					"v_rollSide",				"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "" );
idCVar v_weaponMoveRollSide(		"v_weaponMoveRollSide",		"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "" );

idCVar v_weaponJumpPitch(			"v_weaponJumpPitch",		"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_weaponJumpPush(			"v_weaponJumpPush",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_weaponSprintPulldown(		"v_weaponSprintPulldown",	"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_weaponYawPush(				"v_weaponYawPush",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_weaponYawPushByRoll(		"v_weaponYawPushByRoll",	"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_weaponSwayPitch(			"v_weaponSwayPitch",		"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_weaponSwayYaw(				"v_weaponSwayYaw",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
	   
idCVar v_viewCycleA(				"v_viewCycleA",				"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_viewCycleB(				"v_viewCycleB",				"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_viewSwayCycleX(			"v_viewSwayCycleX",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_viewSwayCycleY(			"v_viewSwayCycleY",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
	   
idCVar v_viewJumpAngleFactor(		"v_viewJumpAngleFactor",	"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_viewSwayPitch(				"v_viewSwayPitch",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
idCVar v_viewSwayYaw(				"v_viewSwayYaw",			"1",			CVAR_GAME | CVAR_FLOAT | CVAR_ARCHIVE, "");
