...
#define	GAME_VERSION		"Odljev_inDev4"
...
const int CS_ENTITIES_START			= MAX_GENTITIES - 1000; // Added by Stradex for COOP
...
typedef struct serverEvent_s
{ //added for coop to avoid events overflow 
	int							eventId;
	idBitMsg					msg;
	bool						saveEvent;
	int							excludeClient;
...
enum {
	...
	GAME_RELIABLE_MESSAGE_GUIEVENT,
...
const float DEFAULT_GRAVITY			= 981.0f;
#define DEFAULT_GRAVITY_STRING		"981"
