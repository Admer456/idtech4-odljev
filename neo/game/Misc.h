...
class admVegetationBendy : public idEntity
{
public:
	CLASS_PROTOTYPE( admVegetationBendy );

						admVegetationBendy( void );
...
class admFuncWater : public idEntity
{
public:
	CLASS_PROTOTYPE( admFuncWater );
