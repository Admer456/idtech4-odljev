...
void idPlayer::Save( idSaveGame *savefile ) const {
	...
	savefile->WriteObject( rtcmCameraFront );
	savefile->WriteObject( rtcmCameraBack );
	savefile->WriteObject( rtcmCameraRight );
	savefile->WriteObject( rtcmCameraLeft );
	savefile->WriteObject( rtcmCameraUp );
	savefile->WriteObject( rtcmCameraDown );
...
void idPlayer::Restore( idRestoreGame *savefile ) {
	...
	savefile->ReadObject( reinterpret_cast<idClass *&>( rtcmCameraFront ) );
	savefile->ReadObject( reinterpret_cast<idClass *&>( rtcmCameraFront ) );
	savefile->ReadObject( reinterpret_cast<idClass *&>( rtcmCameraRight ) );
	savefile->ReadObject( reinterpret_cast<idClass *&>( rtcmCameraLeft ) );
	savefile->ReadObject( reinterpret_cast<idClass *&>( rtcmCameraUp ) );
	savefile->ReadObject( reinterpret_cast<idClass *&>( rtcmCameraDown ) );
...
/*
====================
idPlayer::SetRtcmCamera
====================
*/
void idPlayer::SetRtcmCamera( idCamera *camView, int side )
{
	switch ( side )
	{
	case 0: rtcmCameraFront		= camView; break;
	case 1: rtcmCameraBack		= camView; break;
	case 2: rtcmCameraRight		= camView; break;
	case 3: rtcmCameraLeft		= camView; break;
	case 4: rtcmCameraUp		= camView; break;
	case 5: rtcmCameraDown		= camView; break;
	}
}
