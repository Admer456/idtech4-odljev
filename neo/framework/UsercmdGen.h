...
constexpr int KEY_c = 2;
constexpr int KEY_d = 3;
constexpr int KEY_e = 4;
constexpr int KEY_f = 5;
constexpr int KEY_g = 6;
constexpr int KEY_h = 7;
...
constexpr int KEY_DOT = 27;
constexpr int KEY_OPENBRACKET = 28;
constexpr int KEY_CLOSEBRACKET = 29;
constexpr int KEY_ENTER = 30;
constexpr int KEY_DELETE = 31;

constexpr int NUM_SPACE = 10;
constexpr int NUM_PLUS = 11;
constexpr int NUM_MINUS = 12;
constexpr int NUM_MUL = 13;
constexpr int NUM_DIV = 14;
constexpr int NUM_LCTRL = 15;
constexpr int NUM_DQUOTE = 16;
constexpr int NUM_COMMA = 17;
constexpr int NUM_SHIFT = 18;

struct userkbd_t
{
public:
	int keys = 0;		// 0-26 = a-z; 27 = dot; 28-29 = brackets; 30 = enter; 31 = backspace/delete 
	int oldkeys = 0;

	int numkeys = 0;	// 0-9 = 0-9; 10 = space; 11 = plus; 12 = minus; 13 = asterisk; 14 = slash; 15 = left ctrl; 16 = double quote; 17 = comma
	int oldnumkeys = 0;
};
