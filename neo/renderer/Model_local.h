...
public:
	...
	void						UpdateSurface( const struct renderEntity_t *ent, const idJointMat *joints, modelSurface_t *surf ) const;
...
private:
	...
	// Allows for static MD5. Thank you very much, icecoldduke 
	// jmarshall
	idJointMat                  *poseMat3;
	// jmarshall end
