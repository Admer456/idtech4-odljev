...
public:
	...
	int					GetBlendMode( void ) const { return blendMode; }
	...
	const int			GetContentFlags( void ) const { return contentFlags; }
						...
						// get realtime environment mode
	const int			GetRealTimeMode( void ) const { return realTimeEnvMode; }
